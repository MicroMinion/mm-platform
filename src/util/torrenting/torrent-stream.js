var hat = require('hat')
var pws = require('./peer-wire-swarm.js')
...
var torrentStream = function (link, opts, cb) {
  ...
  engine.connect = function (publicKey) {
    swarm.add(publicKey)
  }

  engine.disconnect = function (publicKey) {
    swarm.remove(publicKey)
  }
